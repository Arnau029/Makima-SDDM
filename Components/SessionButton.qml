    ...
    ComboBox {
        ...
        delegate: ItemDelegate {
            ...
            contentItem: Text {
                ...
                color: selectSession.highlightedIndex === index ? root.palette.highlight.hslLightness >= 0.7 ? "#c42577" : "white" : root.palette.window.hslLightness >= 0.8 ? root.palette.highlight.hslLightness >= 0.8 ? "#006a80" : root.palette.highlight : "white"
